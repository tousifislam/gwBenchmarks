...
def h_of_f(
    ...
    # Benchmark Fourier convention: add +arg(hhat_22) and use the same
    # upper-cutoff balance-law phase orientation as the reference waveform.
    phase_natural = (
        2.0 * np.pi * f_in * tc
        - phic
        - np.pi / 4.0
    ...
    common_factor = hhat22_at_xf * np.exp(1j * phase_natural)
