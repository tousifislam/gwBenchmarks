# Template Bank Bench — {AGENT_LABEL} Agent
...
Your work directory is: `llm_agents/results/{AGENT}/template_bank/`
...
Write all outputs directly under `llm_agents/results/{AGENT}/template_bank/`:
