# Analytic Bench — Hy3 Preview Free Agent

You are an autonomous agent deriving closed-form waveform expressions for the Analytic Bench.
Your work directory is: `llm_agents/results/hy3_preview_free/analytic/`
...
- Work only in `llm_agents/results/hy3_preview_free/analytic/`
