# Remnant Bench — Hy3 Preview Free Agent

You are an autonomous agent building remnant property models for the Remnant Bench.
Your work directory is: `llm_agents/results/hy3_preview_free/remnant/`
...
- Work only in `llm_agents/results/hy3_preview_free/remnant/`
