# Waveform Bench — Hy3 Preview Free Agent

You are an autonomous agent building surrogate models for the Waveform Bench.
Your work directory is: `llm_agents/results/hy3_preview_free/waveform/`
...
- Work only in `llm_agents/results/hy3_preview_free/waveform/`
